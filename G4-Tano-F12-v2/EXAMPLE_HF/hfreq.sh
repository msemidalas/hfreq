...
################################
# MP2-F12/VQZ-F12 force constants #

cat << EOF > "$myfilename".MP2F12.VQZF12.com
gthresh,energy=1d-12,gradient=1d-6,twoint=1d-18,prefac=1d-20
noorient
charge=0
multiplicity=1
...
awk -v geomfile="$output_file_geom" '/geom={/ { print; while ((getline < geomfile) > 0) print; close(geomfile); next } 1' "$myfilename.MP2F12.VQZF12.com" > tmp && mv tmp "$myfilename.MP2F12.VQZF12.com"
...
./runmolpro-es "$myfilename".MP2F12.VQZF12.com 8 1 1500
...
python3 convert_hessian_MOLPRO_to_Psi4.py "$myfilename".MP2F12.VQZF12.out

python3 hessian_G4-Tano-F12-v2.py "$myfilename"
